...
public class PlayerController : MonoBehaviour
{
    ...
    [SerializeField] private float _aimShooting = 10f;
    ...
    private void UpdateAiming()
    {
        ...
        if (lookDir.magnitude > 0.01f) 
        {
            ...
            _aimPivot.rotation = Quaternion.Slerp(_aimPivot.rotation, targerRotation, _aimShooting * Time.deltaTime);
        }
    }
    ...
    private void UpdateMovement()
    {
        ...
        _rb.linearVelocity = inputDir * _moveSpeed;
